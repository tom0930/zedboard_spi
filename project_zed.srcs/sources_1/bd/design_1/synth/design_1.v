...
module design_1
  ...
  wire [23:0]axi_smc_M00_AXI_ARADDR;
  ...
  wire [23:0]axi_smc_M00_AXI_AWADDR;
  ...
  design_1_axi_quad_spi_0_0 axi_quad_spi_0
       (.ext_spi_clk(processing_system7_0_FCLK_CLK0),
        ...
        .s_axi4_araddr(axi_smc_M00_AXI_ARADDR),
        .s_axi4_arburst(axi_smc_M00_AXI_ARBURST),
        .s_axi4_arcache(axi_smc_M00_AXI_ARCACHE),
        .s_axi4_aresetn(rst_ps7_0_50M_peripheral_aresetn),
        .s_axi4_arlen(axi_smc_M00_AXI_ARLEN),
        .s_axi4_arlock(axi_smc_M00_AXI_ARLOCK),
        .s_axi4_arprot(axi_smc_M00_AXI_ARPROT),
        .s_axi4_arready(axi_smc_M00_AXI_ARREADY),
        .s_axi4_arsize(axi_smc_M00_AXI_ARSIZE),
        .s_axi4_arvalid(axi_smc_M00_AXI_ARVALID),
        .s_axi4_awaddr(axi_smc_M00_AXI_AWADDR),
        .s_axi4_awburst(axi_smc_M00_AXI_AWBURST),
        .s_axi4_awcache(axi_smc_M00_AXI_AWCACHE),
        .s_axi4_awlen(axi_smc_M00_AXI_AWLEN),
        .s_axi4_awlock(axi_smc_M00_AXI_AWLOCK),
        .s_axi4_awprot(axi_smc_M00_AXI_AWPROT),
        .s_axi4_awready(axi_smc_M00_AXI_AWREADY),
        .s_axi4_awsize(axi_smc_M00_AXI_AWSIZE),
        .s_axi4_awvalid(axi_smc_M00_AXI_AWVALID),
        .s_axi4_bready(axi_smc_M00_AXI_BREADY),
        .s_axi4_bresp(axi_smc_M00_AXI_BRESP),
        .s_axi4_bvalid(axi_smc_M00_AXI_BVALID),
        .s_axi4_rdata(axi_smc_M00_AXI_RDATA),
        .s_axi4_rlast(axi_smc_M00_AXI_RLAST),
        .s_axi4_rready(axi_smc_M00_AXI_RREADY),
        .s_axi4_rresp(axi_smc_M00_AXI_RRESP),
        .s_axi4_rvalid(axi_smc_M00_AXI_RVALID),
        .s_axi4_wdata(axi_smc_M00_AXI_WDATA),
        .s_axi4_wlast(axi_smc_M00_AXI_WLAST),
        .s_axi4_wready(axi_smc_M00_AXI_WREADY),
        .s_axi4_wstrb(axi_smc_M00_AXI_WSTRB),
        .s_axi4_wvalid(axi_smc_M00_AXI_WVALID),
